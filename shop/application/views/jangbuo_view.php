...
<?    $tmp = $text1 ? "/no/$no/text1/$text1/page/$page" : "/no/$no/page/$page";   ?>
    ...
    <form name="form1" method="jangbuo_insert.html">
        ...
        <!--버튼모음 시작-->
        <div align="center">
            <a class="btn btn-primary mycolor1" href="/~four1/jangbuo/edit<?=$tmp; ?>" role="button">수정</a>
            <a class="btn btn-primary mycolor1" href="/~four1/jangbuo/del<?=$tmp; ?>" role="button">삭제</a>
