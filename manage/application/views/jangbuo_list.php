    ...
    <script>    
        function find_text()
        {
            form1.action="/~four1/jangbuo/lists/text1/"+form1.text1.value+"/page";
            form1.submit();
        }
        $(function() {
    ...
    <form name="form1" action="" method="post">
        <div class="row">
            ...
            <div class="col-9" align="right">
                <a href="/~four1/jangbuo/add<?=$tmp; ?>" class="btn btn-sm mycolor1">추가</a>
            </div>
        </div>
    </form>
    <!--검색창 끝-->
...
<tr>
    <td><?=$no;?></td>
    <td><?=$row->writeday1;?></td>
    <td><a href="/~four1/jangbuo/view/no/<?=$no?><?=$tmp; ?>"><?=$row->product_name1;?></a></td>
    <td><?=$row->price1;?></td>
    <td><?=$row->numo1;?></td>
    <td><?=$row->prices1;?></td>
    <td><?=$row->bigo1;?></td>
